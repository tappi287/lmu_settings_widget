...
freelook_controls = {
    "Freelook Keyboard Pitch Accel": {
        "name": "Keyboard Pitch Accel",
        "desc": "Freelook pitch acceleration when using keyboard",
        "value": 4,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Keyboard Pitch Decel": {
        "name": "Keyboard Pitch Decel",
        "desc": "Freelook pitch deceleration when using keyboard",
        "value": 4,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Keyboard Pitch Speed": {
        "name": "Keyboard Pitch Speed",
        "desc": "Freelook pitch speed when using keyboard",
        "value": 1.5,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Keyboard Yaw Accel": {
        "name": "Keyboard Yaw Accel",
        "desc": "Freelook Yaw acceleration when using keyboard",
        "value": 4,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Keyboard Yaw Decel": {
        "name": "Keyboard Yaw Decel",
        "desc": "Freelook Yaw deceleration when using keyboard",
        "value": 4,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Keyboard Yaw Speed": {
        "name": "Keyboard Yaw Speed",
        "desc": "Freelook yaw speed when using keyboard",
        "value": 1.5,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freelook Mouse Pitch Speed": {
        "name": "Mouse Pitch Speed",
        "desc": "Freelook pitch speed when using mouse",
        "value": 0.004,
        "settings": ({"settingType": "range", "min": 0.00001, "max": 0.1, "step": 0.0001},),
    },
    "Freelook Mouse Yaw Speed": {
        "name": "Mouse Yaw Speed",
        "desc": "Freelook yaw speed when using mouse",
        "value": 0.004,
        "settings": ({"settingType": "range", "min": 0.00001, "max": 0.1, "step": 0.0001},),
    },
    "Freemove Down Speed": {
        "name": "Vertical (Y) Speed",
        "desc": "Freemove Down speed",
        "value": 2.0,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freemove Forward Speed": {
        "name": "Forward (Z) Speed",
        "desc": "Freemove Forward speed",
        "value": 2.0,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
    "Freemove Right Speed": {
        "name": "Horizontal (X) Speed",
        "desc": "Freemove Right speed",
        "value": 2.0,
        "settings": ({"settingType": "range", "min": 0.001, "max": 10.0, "step": 0.001},),
    },
}
...
general_steering = {
        ...
        "settings": (
            {
                ...
                "max": 1440,
                "step": 10,
                "desc": "Default maximum wheel range to use when not read from driver, " "from 40 to 1440 degrees",
            },
        ),
    },
    ...
    "Steering Wheel Software Rotation": {
        ...
        "settings": ({"value": True, "name": "On"}, {"value": False, "name": "Off [Default]"}),
    },
}
