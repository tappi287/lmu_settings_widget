...
game_settings = {
    ...
    "Play Movies": {
        "name": "Play Movies",
        "value": 1,
        "desc": "Enables playback of videos in the UI",
        "settings": ({"value": 1, "name": "Enabled"}, {"value": 0, "name": "Disabled"}),
    },
    "Custom Replay Folder": {
        "name": "Custom Replay Folder",
        "value": "",
        "desc": "Specify a custom folder where to store the replays",
        "settings": tuple(),
    },
    "Auto Skip Garaged Vehicles": {
        "name": "Auto Skip Garage",
        "value": False,
    ...
    "Damper Units": {
        ...
        "settings": (
            {"value": True, "name": "Rate in Nm/s"},
            {"value": False, "name": "Number [Default]"},
        ),
    },
    "RealTimeLogging": {
        "name": "RealTime Logging",
        "value": 0,
        "settings": (
...
app_controller_assignments = {
    "quit_rfactor": {
        "name": "Quit rFactor 2",
        "desc": "Use a controller button to quit rFactor.",
...
session_settings = {
    "GPRIX Opponents": {
        "name": "GRPRIX Opponents",
        "value": 25,
        "desc": "Number of Opponents",
