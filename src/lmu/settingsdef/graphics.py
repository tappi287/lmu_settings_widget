...
advanced_settings = {
    ...
    'Rearview Driving': {'name': 'Rearview Driving', 'value': True,
                         'settings': (
                             {'value': False, 'name': 'Off',
                              'desc': 'Applies to in-game nosecam, cockpit, and TV cockpit'},
                             {'value': True, 'name': 'On'}
                         ), },
    'Rearview Onboard': {'name': 'Rearview Onboard', 'value': False,
                         'settings': (
                             {'value': False, 'name': 'Off', 'desc': 'Applies to in-game onboard cams'},
                             {'value': True, 'name': 'On'}
                         ), },
    'Rearview Swingman': {'name': 'Rearview Swingman', 'value': True,
                          'settings': (
